...
variable "prod_eu_account_id" { type = string; default = "" }
variable "eu_replica_kms_key_arn" { type = string; default = "" }
variable "enable_shield_advanced" { type = bool; default = false }
variable "secrets_rotation_lambda_arn" { type = string; default = "" }
variable "canary_test_username" { type = string; default = "" }
variable "canary_test_password" { type = string; sensitive = true; default = "" }
